<?php
include 'backend/conn.php'; // Ensure this file includes your database connection setup
...
if ($stmt->execute()) {
    ...
    if ($allItemsInserted) {
        ...
        header("Location: print.php?invoice=$invoiceNumber"); // Redirect to index.php after successful creation
        exit();
    } else {
